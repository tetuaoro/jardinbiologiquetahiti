...
const Header = () => {
  return (
    <header className="pt-sm-3 pb-3 pb-sm-5">
        ...
        <Container fluid>
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav as="ul" className="mx-auto align-items-center poppins">
              ...
              <Nav.Item as="li" className="ms-md-5">
                <Link href="/test">
                  <Nav.Link href="/test">PRODUITS</Nav.Link>
                </Link>
              </Nav.Item>
              <Nav.Item as="li" className="ms-md-5">
                <Link href="#pricing">
            ...
            <section className="navbar-text d-flex justify-content-center me-md-5">
